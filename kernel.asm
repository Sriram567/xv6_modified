...
80101d84:	0f 84 86 01 00 00    	je     80101f10 <namex+0x1a0>
    ...
    ip = idup(myproc()->cwd);
80101d8a:	e8 71 1c 00 00       	call   80103a00 <myproc>
  acquire(&icache.lock);
...
80102486:	81 fb a8 7c 11 80    	cmp    $0x80117ca8,%ebx
...
8010305b:	68 a8 7c 11 80       	push   $0x80117ca8
...
80103088:	e8 83 32 00 00       	call   80106310 <uartinit>
  pinit();         // process table
8010308d:	e8 be 08 00 00       	call   80103950 <pinit>
  tvinit();        // trap vectors
...
80103162:	e8 c9 08 00 00       	call   80103a30 <userinit>
...
801035f5:	8d 76 00             	lea    0x0(%esi),%esi
      if(p->readopen == 0 || myproc()->killed){
801035f8:	e8 03 04 00 00       	call   80103a00 <myproc>
...
801036d2:	8d b6 00 00 00 00    	lea    0x0(%esi),%esi
    if(myproc()->killed){
801036d8:	e8 23 03 00 00       	call   80103a00 <myproc>
...
801037a1:	e8 ea 13 00 00       	call   80104b90 <acquire>
801037a6:	83 c4 10             	add    $0x10,%esp
801037a9:	eb 17                	jmp    801037c2 <allocproc+0x32>
801037ab:	8d 74 26 00          	lea    0x0(%esi,%eiz,1),%esi
801037af:	90                   	nop
  for(p = ptable.proc; p < &ptable.proc[NPROC]; p++)
801037b0:	81 c3 dc 00 00 00    	add    $0xdc,%ebx
801037b6:	81 fb 54 74 11 80    	cmp    $0x80117454,%ebx
...
801037c9:	a1 04 b0 10 80       	mov    0x8010b004,%eax
  ...
  {
	p->priority = 2;
801037ce:	b9 02 00 00 00       	mov    $0x2,%ecx
  p->state = EMBRYO;
801037d3:	c7 43 0c 01 00 00 00 	movl   $0x1,0xc(%ebx)
  p->rtime = 0;
801037da:	c7 43 7c 00 00 00 00 	movl   $0x0,0x7c(%ebx)
  p->pid = nextpid++;
801037e1:	8d 50 01             	lea    0x1(%eax),%edx
	p->priority = 2;
801037e4:	83 f8 02             	cmp    $0x2,%eax
  p->pid = nextpid++;
801037e7:	89 43 10             	mov    %eax,0x10(%ebx)
	p->priority = 2;
801037ea:	b8 3c 00 00 00       	mov    $0x3c,%eax
  p->pid = nextpid++;
801037ef:	89 15 04 b0 10 80    	mov    %edx,0x8010b004
	p->priority = 2;
801037f5:	0f 4e c1             	cmovle %ecx,%eax
  p->ctime = ticks;
801037f8:	8b 15 a0 7c 11 80    	mov    0x80117ca0,%edx
801037fe:	8d 8b b4 00 00 00    	lea    0xb4(%ebx),%ecx
  p->runtime = 0;
80103804:	c7 83 80 00 00 00 00 	movl   $0x0,0x80(%ebx)
8010380b:	00 00 00 
  p->ctime = ticks;
8010380e:	89 93 8c 00 00 00    	mov    %edx,0x8c(%ebx)
  p->lastentertime = ticks;
80103814:	89 93 d4 00 00 00    	mov    %edx,0xd4(%ebx)
  p->wtime = 0;
8010381a:	c7 83 84 00 00 00 00 	movl   $0x0,0x84(%ebx)
80103821:	00 00 00 
  p->waittime = 0;
80103824:	c7 83 88 00 00 00 00 	movl   $0x0,0x88(%ebx)
8010382b:	00 00 00 
  p->iowaittime = 0;
8010382e:	c7 83 98 00 00 00 00 	movl   $0x0,0x98(%ebx)
80103835:	00 00 00 
  p->cur_q = -5;
80103838:	c7 83 b4 00 00 00 fb 	movl   $0xfffffffb,0xb4(%ebx)
8010383f:	ff ff ff 
  p->currentslice=0;
80103842:	c7 83 d8 00 00 00 00 	movl   $0x0,0xd8(%ebx)
80103849:	00 00 00 
	p->priority = 2;
8010384c:	89 83 94 00 00 00    	mov    %eax,0x94(%ebx)
80103852:	8d 83 9c 00 00 00    	lea    0x9c(%ebx),%eax
...
80103866:	83 c0 04             	add    $0x4,%eax
80103869:	89 50 1c             	mov    %edx,0x1c(%eax)
  for(int iii = 0;iii<6 ;iii++)
8010386c:	39 c1                	cmp    %eax,%ecx
8010386e:	75 f0                	jne    80103860 <allocproc+0xd0>
  }
  p->n_run = 0;
80103870:	c7 83 b8 00 00 00 00 	movl   $0x0,0xb8(%ebx)
80103877:	00 00 00 
  release(&ptable.lock);
8010387a:	83 ec 0c             	sub    $0xc,%esp
8010387d:	68 20 3d 11 80       	push   $0x80113d20
80103882:	e8 c9 13 00 00       	call   80104c50 <release>

  // Allocate kernel stack.
  if((p->kstack = kalloc()) == 0){
80103887:	e8 a4 ed ff ff       	call   80102630 <kalloc>
8010388c:	83 c4 10             	add    $0x10,%esp
8010388f:	89 43 08             	mov    %eax,0x8(%ebx)
80103892:	85 c0                	test   %eax,%eax
80103894:	74 53                	je     801038e9 <allocproc+0x159>
    return 0;
  }
...
801038a4:	89 53 18             	mov    %edx,0x18(%ebx)
  *(uint*)sp = (uint)trapret;
801038a7:	c7 40 14 71 5f 10 80 	movl   $0x80105f71,0x14(%eax)
  p->context = (struct context*)sp;
...
801038b6:	e8 e5 13 00 00       	call   80104ca0 <memset>
...
801038da:	e8 71 13 00 00       	call   80104c50 <release>
}
...
8010390f:	e8 3c 13 00 00       	call   80104c50 <release>
...
80103937:	e8 04 dc ff ff       	call   80101540 <iinit>
    initlog(ROOTDEV);
8010393c:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
80103943:	e8 48 f3 ff ff       	call   80102c90 <initlog>
}
...
8010395a:	68 20 7d 10 80       	push   $0x80107d20
8010395f:	68 20 3d 11 80       	push   $0x80113d20
80103964:	e8 a7 10 00 00       	call   80104a10 <initlock>
}
...
80103a08:	83 ec 04             	sub    $0x4,%esp
  pushcli();
80103a0b:	e8 80 10 00 00       	call   80104a90 <pushcli>
  c = mycpu();
80103a10:	e8 5b ff ff ff       	call   80103970 <mycpu>
  p = c->proc;
80103a15:	8b 98 ac 00 00 00    	mov    0xac(%eax),%ebx
  popcli();
80103a1b:	e8 c0 10 00 00       	call   80104ae0 <popcli>
}
...
80103a38:	83 ec 04             	sub    $0x4,%esp
  p = allocproc();
80103a3b:	e8 50 fd ff ff       	call   80103790 <allocproc>
80103a40:	89 c3                	mov    %eax,%ebx
  initproc = p;
80103a42:	a3 b8 b5 10 80       	mov    %eax,0x8010b5b8
  if((p->pgdir = setupkvm()) == 0)
80103a47:	e8 f4 3a 00 00       	call   80107540 <setupkvm>
...
80103a65:	e8 a6 37 00 00       	call   80107210 <inituvm>
...
80103a7a:	e8 21 12 00 00       	call   80104ca0 <memset>
...
80103ad3:	68 50 7d 10 80       	push   $0x80107d50
80103ad8:	50                   	push   %eax
80103ad9:	e8 82 13 00 00       	call   80104e60 <safestrcpy>
  p->cwd = namei("/");
80103ade:	c7 04 24 59 7d 10 80 	movl   $0x80107d59,(%esp)
80103ae5:	e8 46 e5 ff ff       	call   80102030 <namei>
80103aea:	89 43 68             	mov    %eax,0x68(%ebx)
  acquire(&ptable.lock);
80103aed:	c7 04 24 20 3d 11 80 	movl   $0x80113d20,(%esp)
80103af4:	e8 97 10 00 00       	call   80104b90 <acquire>
  p->state = RUNNABLE;
80103af9:	c7 43 0c 03 00 00 00 	movl   $0x3,0xc(%ebx)
  release(&ptable.lock);
80103b00:	c7 04 24 20 3d 11 80 	movl   $0x80113d20,(%esp)
80103b07:	e8 44 11 00 00       	call   80104c50 <release>
}
...
80103b17:	68 37 7d 10 80       	push   $0x80107d37
...
80103b39:	8b 75 08             	mov    0x8(%ebp),%esi
  pushcli();
80103b3c:	e8 4f 0f 00 00       	call   80104a90 <pushcli>
  c = mycpu();
80103b41:	e8 2a fe ff ff       	call   80103970 <mycpu>
  p = c->proc;
80103b46:	8b 98 ac 00 00 00    	mov    0xac(%eax),%ebx
  popcli();
80103b4c:	e8 8f 0f 00 00       	call   80104ae0 <popcli>
  sz = curproc->sz;
...
80103b5f:	e8 9c 35 00 00       	call   80107100 <switchuvm>
  return 0;
...
80103b7a:	e8 e1 37 00 00       	call   80107360 <allocuvm>
...
80103b9a:	e8 f1 38 00 00       	call   80107490 <deallocuvm>
...
80103bba:	83 ec 1c             	sub    $0x1c,%esp
  pushcli();
80103bbd:	e8 ce 0e 00 00       	call   80104a90 <pushcli>
  c = mycpu();
80103bc2:	e8 a9 fd ff ff       	call   80103970 <mycpu>
  p = c->proc;
80103bc7:	8b 98 ac 00 00 00    	mov    0xac(%eax),%ebx
  popcli();
80103bcd:	e8 0e 0f 00 00       	call   80104ae0 <popcli>
  if((np = allocproc()) == 0){
80103bd2:	e8 b9 fb ff ff       	call   80103790 <allocproc>
...
80103bec:	e8 1f 3a 00 00       	call   80107610 <copyuvm>
...
80103c34:	e8 37 d2 ff ff       	call   80100e70 <filedup>
...
80103c51:	83 c3 6c             	add    $0x6c,%ebx
  np->cwd = idup(curproc->cwd);
80103c54:	e8 d7 da ff ff       	call   80101730 <idup>
...
80103cad:	e8 be e7 ff ff       	call   80102470 <kfree>
    np->kstack = 0;
...
80103cd5:	b8 54 3d 11 80       	mov    $0x80113d54,%eax
{
80103cda:	89 e5                	mov    %esp,%ebp
80103cdc:	56                   	push   %esi
80103cdd:	53                   	push   %ebx
80103cde:	83 ec 20             	sub    $0x20,%esp
  agefactor[0] = 25;
80103ce1:	c7 45 e0 19 00 00 00 	movl   $0x19,-0x20(%ebp)
	pp->lastentertime = ticks;
80103ce8:	8b 1d a0 7c 11 80    	mov    0x80117ca0,%ebx
  agefactor[1] = 35;
80103cee:	c7 45 e4 23 00 00 00 	movl   $0x23,-0x1c(%ebp)
  agefactor[2] = 40;
80103cf5:	c7 45 e8 28 00 00 00 	movl   $0x28,-0x18(%ebp)
  agefactor[3] = 40;
80103cfc:	c7 45 ec 28 00 00 00 	movl   $0x28,-0x14(%ebp)
  agefactor[4] = 50;
80103d03:	c7 45 f0 32 00 00 00 	movl   $0x32,-0x10(%ebp)
  for(pp = ptable.proc; pp< &ptable.proc[NPROC]; pp++)
80103d0a:	8d b6 00 00 00 00    	lea    0x0(%esi),%esi
    if(pp->state!= RUNNABLE || pp->cur_q < 0)
80103d10:	83 78 0c 03          	cmpl   $0x3,0xc(%eax)
80103d14:	75 5a                	jne    80103d70 <aging+0xa0>
80103d16:	8b 90 b4 00 00 00    	mov    0xb4(%eax),%edx
80103d1c:	85 d2                	test   %edx,%edx
80103d1e:	78 50                	js     80103d70 <aging+0xa0>
    if(pp->waittime >= agefactor[pp->cur_q])
80103d20:	8b 88 88 00 00 00    	mov    0x88(%eax),%ecx
      if(pp->cur_q >= 1)
80103d26:	3b 4c 95 e0          	cmp    -0x20(%ebp,%edx,4),%ecx
80103d2a:	7c 44                	jl     80103d70 <aging+0xa0>
80103d2c:	85 d2                	test   %edx,%edx
80103d2e:	74 40                	je     80103d70 <aging+0xa0>
        pp->cur_q = pp->cur_q - 1;
80103d30:	8d 72 ff             	lea    -0x1(%edx),%esi
	pp->wtime += pp->waittime;
80103d33:	01 88 84 00 00 00    	add    %ecx,0x84(%eax)
        pp->cur_q = pp->cur_q - 1;
80103d39:	89 b0 b4 00 00 00    	mov    %esi,0xb4(%eax)
        pp->currentslice = 0;
80103d3f:	c7 80 d8 00 00 00 00 	movl   $0x0,0xd8(%eax)
80103d46:	00 00 00 
	pp->lastentertime = ticks;
80103d49:	89 98 d4 00 00 00    	mov    %ebx,0xd4(%eax)
        pp->waittime = 0;
80103d4f:	c7 80 88 00 00 00 00 	movl   $0x0,0x88(%eax)
80103d56:	00 00 00 
        pp->iowaittime = 0;
80103d59:	c7 80 98 00 00 00 00 	movl   $0x0,0x98(%eax)
80103d60:	00 00 00 
        pp->qentertime[pp->cur_q] = ticks;
80103d63:	89 9c 90 b8 00 00 00 	mov    %ebx,0xb8(%eax,%edx,4)
80103d6a:	8d b6 00 00 00 00    	lea    0x0(%esi),%esi
  for(pp = ptable.proc; pp< &ptable.proc[NPROC]; pp++)
80103d70:	05 dc 00 00 00       	add    $0xdc,%eax
80103d75:	3d 54 74 11 80       	cmp    $0x80117454,%eax
80103d7a:	75 94                	jne    80103d10 <aging+0x40>
}
80103d7c:	83 c4 20             	add    $0x20,%esp
80103d7f:	5b                   	pop    %ebx
80103d80:	5e                   	pop    %esi
80103d81:	5d                   	pop    %ebp
80103d82:	c3                   	ret    
...
80103d97:	83 ec 14             	sub    $0x14,%esp
    acquire (&ptable.lock);
80103d9a:	68 20 3d 11 80       	push   $0x80113d20
80103d9f:	e8 ec 0d 00 00       	call   80104b90 <acquire>
	    p->lastentertime = ticks;
80103da4:	8b 0d a0 7c 11 80    	mov    0x80117ca0,%ecx
80103daa:	83 c4 10             	add    $0x10,%esp
    for (p=ptable.proc;p<&ptable.proc[NPROC];p++)
80103dad:	b8 54 3d 11 80       	mov    $0x80113d54,%eax
80103db2:	eb 2c                	jmp    80103de0 <updateruntime+0x50>
80103db4:	8d 74 26 00          	lea    0x0(%esi,%eiz,1),%esi
	if(p->state == SLEEPING)
80103db8:	83 fa 02             	cmp    $0x2,%edx
80103dbb:	75 17                	jne    80103dd4 <updateruntime+0x44>
	    p->iowaittime++;
80103dbd:	83 80 98 00 00 00 01 	addl   $0x1,0x98(%eax)
	    p->waittime = 0;
80103dc4:	c7 80 88 00 00 00 00 	movl   $0x0,0x88(%eax)
80103dcb:	00 00 00 
	    p->lastentertime = ticks;
80103dce:	89 88 d4 00 00 00    	mov    %ecx,0xd4(%eax)
    for (p=ptable.proc;p<&ptable.proc[NPROC];p++)
80103dd4:	05 dc 00 00 00       	add    $0xdc,%eax
80103dd9:	3d 54 74 11 80       	cmp    $0x80117454,%eax
80103dde:	74 20                	je     80103e00 <updateruntime+0x70>
        if (p->state == RUNNING)
80103de0:	8b 50 0c             	mov    0xc(%eax),%edx
80103de3:	83 fa 04             	cmp    $0x4,%edx
80103de6:	74 30                	je     80103e18 <updateruntime+0x88>
        if (p->state == RUNNABLE)
80103de8:	83 fa 03             	cmp    $0x3,%edx
80103deb:	75 cb                	jne    80103db8 <updateruntime+0x28>
            p->waittime++;
80103ded:	83 80 88 00 00 00 01 	addl   $0x1,0x88(%eax)
    for (p=ptable.proc;p<&ptable.proc[NPROC];p++)
80103df4:	05 dc 00 00 00       	add    $0xdc,%eax
80103df9:	3d 54 74 11 80       	cmp    $0x80117454,%eax
80103dfe:	75 e0                	jne    80103de0 <updateruntime+0x50>
    release(&ptable.lock);
80103e00:	83 ec 0c             	sub    $0xc,%esp
80103e03:	68 20 3d 11 80       	push   $0x80113d20
80103e08:	e8 43 0e 00 00       	call   80104c50 <release>
}
...
80103e12:	8d b6 00 00 00 00    	lea    0x0(%esi),%esi
            p->runtime++;
80103e18:	8b 90 b4 00 00 00    	mov    0xb4(%eax),%edx
80103e1e:	83 80 80 00 00 00 01 	addl   $0x1,0x80(%eax)
	    p->q[p->cur_q]++;
80103e25:	83 84 90 9c 00 00 00 	addl   $0x1,0x9c(%eax,%edx,4)
80103e2c:	01 
            p->currentslice++;
80103e2d:	83 80 d8 00 00 00 01 	addl   $0x1,0xd8(%eax)
	if(p->state == SLEEPING)
80103e34:	eb 9e                	jmp    80103dd4 <updateruntime+0x44>
...
80103e4a:	83 ec 0c             	sub    $0xc,%esp
  struct cpu *c = mycpu();
80103e4d:	e8 1e fb ff ff       	call   80103970 <mycpu>
  c->proc = 0;
...
80103e69:	83 ec 0c             	sub    $0xc,%esp
    for(p = ptable.proc; p < &ptable.proc[NPROC]; p++){
80103e6c:	bb 54 3d 11 80       	mov    $0x80113d54,%ebx
    acquire(&ptable.lock);
80103e71:	68 20 3d 11 80       	push   $0x80113d20
80103e76:	e8 15 0d 00 00       	call   80104b90 <acquire>
80103e7b:	83 c4 10             	add    $0x10,%esp
80103e7e:	66 90                	xchg   %ax,%ax
      if(p->state != RUNNABLE)
80103e80:	83 7b 0c 03          	cmpl   $0x3,0xc(%ebx)
80103e84:	75 50                	jne    80103ed6 <scheduler+0x96>
      switchuvm(p);
...
80103e90:	e8 6b 32 00 00       	call   80107100 <switchuvm>
      p->wtime +=  p->waittime;
80103e95:	8b 83 88 00 00 00    	mov    0x88(%ebx),%eax
80103e9b:	01 83 84 00 00 00    	add    %eax,0x84(%ebx)
      swtch(&(c->scheduler), p->context);
80103ea1:	58                   	pop    %eax
80103ea2:	5a                   	pop    %edx
80103ea3:	ff 73 1c             	pushl  0x1c(%ebx)
80103ea6:	57                   	push   %edi
      p->n_run++;
80103ea7:	83 83 b8 00 00 00 01 	addl   $0x1,0xb8(%ebx)
      p->state = RUNNING;
80103eae:	c7 43 0c 04 00 00 00 	movl   $0x4,0xc(%ebx)
      p->waittime = 0;
80103eb5:	c7 83 88 00 00 00 00 	movl   $0x0,0x88(%ebx)
80103ebc:	00 00 00 
      swtch(&(c->scheduler), p->context);
80103ebf:	e8 ff 0f 00 00       	call   80104ec3 <swtch>
      switchkvm();
80103ec4:	e8 17 32 00 00       	call   801070e0 <switchkvm>
      c->proc = 0;
80103ec9:	83 c4 10             	add    $0x10,%esp
80103ecc:	c7 86 ac 00 00 00 00 	movl   $0x0,0xac(%esi)
80103ed3:	00 00 00 
    for(p = ptable.proc; p < &ptable.proc[NPROC]; p++){
80103ed6:	81 c3 dc 00 00 00    	add    $0xdc,%ebx
80103edc:	81 fb 54 74 11 80    	cmp    $0x80117454,%ebx
80103ee2:	75 9c                	jne    80103e80 <scheduler+0x40>
    release(&ptable.lock);
80103ee4:	83 ec 0c             	sub    $0xc,%esp
80103ee7:	68 20 3d 11 80       	push   $0x80113d20
80103eec:	e8 5f 0d 00 00       	call   80104c50 <release>
    sti();
80103ef1:	83 c4 10             	add    $0x10,%esp
80103ef4:	e9 6f ff ff ff       	jmp    80103e68 <scheduler+0x28>
...
80103f08:	53                   	push   %ebx
  pushcli();
80103f09:	e8 82 0b 00 00       	call   80104a90 <pushcli>
  c = mycpu();
80103f0e:	e8 5d fa ff ff       	call   80103970 <mycpu>
  p = c->proc;
80103f13:	8b 98 ac 00 00 00    	mov    0xac(%eax),%ebx
  popcli();
80103f19:	e8 c2 0b 00 00       	call   80104ae0 <popcli>
  if(!holding(&ptable.lock))
80103f1e:	83 ec 0c             	sub    $0xc,%esp
80103f21:	68 20 3d 11 80       	push   $0x80113d20
80103f26:	e8 15 0c 00 00       	call   80104b40 <holding>
80103f2b:	83 c4 10             	add    $0x10,%esp
80103f2e:	85 c0                	test   %eax,%eax
80103f30:	74 4f                	je     80103f81 <sched+0x81>
  if(mycpu()->ncli != 1)
80103f32:	e8 39 fa ff ff       	call   80103970 <mycpu>
...
80103f4b:	75 41                	jne    80103f8e <sched+0x8e>
  intena = mycpu()->intena;
80103f4d:	e8 1e fa ff ff       	call   80103970 <mycpu>
  swtch(&p->context, mycpu()->scheduler);
80103f52:	83 c3 1c             	add    $0x1c,%ebx
  intena = mycpu()->intena;
80103f55:	8b b0 a8 00 00 00    	mov    0xa8(%eax),%esi
  swtch(&p->context, mycpu()->scheduler);
80103f5b:	e8 10 fa ff ff       	call   80103970 <mycpu>
80103f60:	83 ec 08             	sub    $0x8,%esp
80103f63:	ff 70 04             	pushl  0x4(%eax)
80103f66:	53                   	push   %ebx
80103f67:	e8 57 0f 00 00       	call   80104ec3 <swtch>
  mycpu()->intena = intena;
80103f6c:	e8 ff f9 ff ff       	call   80103970 <mycpu>
}
...
80103fca:	83 ec 0c             	sub    $0xc,%esp
  pushcli();
80103fcd:	e8 be 0a 00 00       	call   80104a90 <pushcli>
  c = mycpu();
80103fd2:	e8 99 f9 ff ff       	call   80103970 <mycpu>
  p = c->proc;
80103fd7:	8b 98 ac 00 00 00    	mov    0xac(%eax),%ebx
  popcli();
80103fdd:	e8 fe 0a 00 00       	call   80104ae0 <popcli>
  if(curproc == initproc)
80103fe2:	8d 73 28             	lea    0x28(%ebx),%esi
80103fe5:	8d 7b 68             	lea    0x68(%ebx),%edi
80103fe8:	39 1d b8 b5 10 80    	cmp    %ebx,0x8010b5b8
80103fee:	0f 84 12 01 00 00    	je     80104106 <exit+0x146>
...
8010401f:	ff 73 68             	pushl  0x68(%ebx)
80104022:	e8 69 d8 ff ff       	call   80101890 <iput>
  end_op();
80104027:	e8 74 ed ff ff       	call   80102da0 <end_op>
  curproc->cwd = 0;
8010402c:	c7 43 68 00 00 00 00 	movl   $0x0,0x68(%ebx)
  acquire(&ptable.lock);
80104033:	c7 04 24 20 3d 11 80 	movl   $0x80113d20,(%esp)
8010403a:	e8 51 0b 00 00       	call   80104b90 <acquire>
...
wakeup1(void *chan)
{
  ...
  for(p = ptable.proc; p < &ptable.proc[NPROC]; p++)
80104045:	b8 54 3d 11 80       	mov    $0x80113d54,%eax
8010404a:	eb 10                	jmp    8010405c <exit+0x9c>
8010404c:	8d 74 26 00          	lea    0x0(%esi,%eiz,1),%esi
80104050:	05 dc 00 00 00       	add    $0xdc,%eax
80104055:	3d 54 74 11 80       	cmp    $0x80117454,%eax
8010405a:	74 1e                	je     8010407a <exit+0xba>
    if(p->state == SLEEPING && p->chan == chan)
8010405c:	83 78 0c 02          	cmpl   $0x2,0xc(%eax)
80104060:	75 ee                	jne    80104050 <exit+0x90>
80104062:	3b 50 20             	cmp    0x20(%eax),%edx
80104065:	75 e9                	jne    80104050 <exit+0x90>
      p->state = RUNNABLE;
80104067:	c7 40 0c 03 00 00 00 	movl   $0x3,0xc(%eax)
  for(p = ptable.proc; p < &ptable.proc[NPROC]; p++)
8010406e:	05 dc 00 00 00       	add    $0xdc,%eax
80104073:	3d 54 74 11 80       	cmp    $0x80117454,%eax
80104078:	75 e2                	jne    8010405c <exit+0x9c>
      p->parent = initproc;
8010407a:	8b 0d b8 b5 10 80    	mov    0x8010b5b8,%ecx
  for(p = ptable.proc; p < &ptable.proc[NPROC]; p++){
80104080:	ba 54 3d 11 80       	mov    $0x80113d54,%edx
80104085:	eb 17                	jmp    8010409e <exit+0xde>
80104087:	8d b4 26 00 00 00 00 	lea    0x0(%esi,%eiz,1),%esi
8010408e:	66 90                	xchg   %ax,%ax
80104090:	81 c2 dc 00 00 00    	add    $0xdc,%edx
80104096:	81 fa 54 74 11 80    	cmp    $0x80117454,%edx
8010409c:	74 3a                	je     801040d8 <exit+0x118>
    if(p->parent == curproc){
8010409e:	39 5a 14             	cmp    %ebx,0x14(%edx)
801040a1:	75 ed                	jne    80104090 <exit+0xd0>
      if(p->state == ZOMBIE)
801040a3:	83 7a 0c 05          	cmpl   $0x5,0xc(%edx)
      p->parent = initproc;
801040a7:	89 4a 14             	mov    %ecx,0x14(%edx)
      if(p->state == ZOMBIE)
801040aa:	75 e4                	jne    80104090 <exit+0xd0>
  for(p = ptable.proc; p < &ptable.proc[NPROC]; p++)
801040ac:	b8 54 3d 11 80       	mov    $0x80113d54,%eax
801040b1:	eb 11                	jmp    801040c4 <exit+0x104>
801040b3:	8d 74 26 00          	lea    0x0(%esi,%eiz,1),%esi
801040b7:	90                   	nop
801040b8:	05 dc 00 00 00       	add    $0xdc,%eax
801040bd:	3d 54 74 11 80       	cmp    $0x80117454,%eax
801040c2:	74 cc                	je     80104090 <exit+0xd0>
    if(p->state == SLEEPING && p->chan == chan)
801040c4:	83 78 0c 02          	cmpl   $0x2,0xc(%eax)
801040c8:	75 ee                	jne    801040b8 <exit+0xf8>
801040ca:	3b 48 20             	cmp    0x20(%eax),%ecx
801040cd:	75 e9                	jne    801040b8 <exit+0xf8>
      p->state = RUNNABLE;
801040cf:	c7 40 0c 03 00 00 00 	movl   $0x3,0xc(%eax)
801040d6:	eb e0                	jmp    801040b8 <exit+0xf8>
  curproc->etime = ticks;
801040d8:	a1 a0 7c 11 80       	mov    0x80117ca0,%eax
  curproc->state = ZOMBIE;
801040dd:	c7 43 0c 05 00 00 00 	movl   $0x5,0xc(%ebx)
  curproc->cur_q = -5;
801040e4:	c7 83 b4 00 00 00 fb 	movl   $0xfffffffb,0xb4(%ebx)
801040eb:	ff ff ff 
  curproc->etime = ticks;
801040ee:	89 83 90 00 00 00    	mov    %eax,0x90(%ebx)
  sched();
801040f4:	e8 07 fe ff ff       	call   80103f00 <sched>
  panic("zombie exit");
801040f9:	83 ec 0c             	sub    $0xc,%esp
801040fc:	68 a8 7d 10 80       	push   $0x80107da8
80104101:	e8 8a c2 ff ff       	call   80100390 <panic>
    panic("init exiting");
80104106:	83 ec 0c             	sub    $0xc,%esp
80104109:	68 9b 7d 10 80       	push   $0x80107d9b
...
80104135:	e8 56 09 00 00       	call   80104a90 <pushcli>
  c = mycpu();
8010413a:	e8 31 f8 ff ff       	call   80103970 <mycpu>
  p = c->proc;
...
8010414a:	c7 43 0c 03 00 00 00 	movl   $0x3,0xc(%ebx)
  sched();
80104151:	e8 aa fd ff ff       	call   80103f00 <sched>
  release(&ptable.lock);
...
80104183:	e8 08 09 00 00       	call   80104a90 <pushcli>
  c = mycpu();
80104188:	e8 e3 f7 ff ff       	call   80103970 <mycpu>
  p = c->proc;
...
8010419a:	0f 84 83 00 00 00    	je     80104223 <sleep+0xb3>
  if(lk == 0)
801041a0:	85 f6                	test   %esi,%esi
801041a2:	74 72                	je     80104216 <sleep+0xa6>
  if(lk != &ptable.lock){  //DOC: sleeplock0
801041a4:	81 fe 20 3d 11 80    	cmp    $0x80113d20,%esi
801041aa:	74 4c                	je     801041f8 <sleep+0x88>
    acquire(&ptable.lock);  //DOC: sleeplock1
801041ac:	83 ec 0c             	sub    $0xc,%esp
801041af:	68 20 3d 11 80       	push   $0x80113d20
801041b4:	e8 d7 09 00 00       	call   80104b90 <acquire>
    release(lk);
801041b9:	89 34 24             	mov    %esi,(%esp)
801041bc:	e8 8f 0a 00 00       	call   80104c50 <release>
  p->chan = chan;
801041c1:	89 7b 20             	mov    %edi,0x20(%ebx)
  p->state = SLEEPING;
801041c4:	c7 43 0c 02 00 00 00 	movl   $0x2,0xc(%ebx)
  sched();
801041cb:	e8 30 fd ff ff       	call   80103f00 <sched>
  p->chan = 0;
801041d0:	c7 43 20 00 00 00 00 	movl   $0x0,0x20(%ebx)
    release(&ptable.lock);
801041d7:	c7 04 24 20 3d 11 80 	movl   $0x80113d20,(%esp)
801041de:	e8 6d 0a 00 00       	call   80104c50 <release>
    acquire(lk);
...
801041ef:	5d                   	pop    %ebp
    acquire(lk);
801041f0:	e9 9b 09 00 00       	jmp    80104b90 <acquire>
...
801041fb:	c7 43 0c 02 00 00 00 	movl   $0x2,0xc(%ebx)
  sched();
80104202:	e8 f9 fc ff ff       	call   80103f00 <sched>
  p->chan = 0;
...
80104219:	68 ba 7d 10 80       	push   $0x80107dba
8010421e:	e8 6d c1 ff ff       	call   80100390 <panic>
    panic("sleep");
80104223:	83 ec 0c             	sub    $0xc,%esp
80104226:	68 b4 7d 10 80       	push   $0x80107db4
8010422b:	e8 60 c1 ff ff       	call   80100390 <panic>
...
80104238:	53                   	push   %ebx
  pushcli();
80104239:	e8 52 08 00 00       	call   80104a90 <pushcli>
  c = mycpu();
8010423e:	e8 2d f7 ff ff       	call   80103970 <mycpu>
  p = c->proc;
80104243:	8b b0 ac 00 00 00    	mov    0xac(%eax),%esi
  popcli();
80104249:	e8 92 08 00 00       	call   80104ae0 <popcli>
  acquire(&ptable.lock);
8010424e:	83 ec 0c             	sub    $0xc,%esp
80104251:	68 20 3d 11 80       	push   $0x80113d20
80104256:	e8 35 09 00 00       	call   80104b90 <acquire>
8010425b:	83 c4 10             	add    $0x10,%esp
    havekids = 0;
8010425e:	31 c0                	xor    %eax,%eax
    for(p = ptable.proc; p < &ptable.proc[NPROC]; p++){
80104260:	bb 54 3d 11 80       	mov    $0x80113d54,%ebx
80104265:	eb 17                	jmp    8010427e <wait+0x4e>
80104267:	8d b4 26 00 00 00 00 	lea    0x0(%esi,%eiz,1),%esi
8010426e:	66 90                	xchg   %ax,%ax
80104270:	81 c3 dc 00 00 00    	add    $0xdc,%ebx
80104276:	81 fb 54 74 11 80    	cmp    $0x80117454,%ebx
8010427c:	74 1e                	je     8010429c <wait+0x6c>
      if(p->parent != curproc)
8010427e:	39 73 14             	cmp    %esi,0x14(%ebx)
80104281:	75 ed                	jne    80104270 <wait+0x40>
      if(p->state == ZOMBIE){
80104283:	83 7b 0c 05          	cmpl   $0x5,0xc(%ebx)
80104287:	74 37                	je     801042c0 <wait+0x90>
    for(p = ptable.proc; p < &ptable.proc[NPROC]; p++){
80104289:	81 c3 dc 00 00 00    	add    $0xdc,%ebx
      havekids = 1;
8010428f:	b8 01 00 00 00       	mov    $0x1,%eax
    for(p = ptable.proc; p < &ptable.proc[NPROC]; p++){
80104294:	81 fb 54 74 11 80    	cmp    $0x80117454,%ebx
8010429a:	75 e2                	jne    8010427e <wait+0x4e>
    if(!havekids || curproc->killed){
8010429c:	85 c0                	test   %eax,%eax
8010429e:	74 76                	je     80104316 <wait+0xe6>
801042a0:	8b 46 24             	mov    0x24(%esi),%eax
801042a3:	85 c0                	test   %eax,%eax
801042a5:	75 6f                	jne    80104316 <wait+0xe6>
    sleep(curproc, &ptable.lock);  //DOC: wait-sleep
801042a7:	83 ec 08             	sub    $0x8,%esp
801042aa:	68 20 3d 11 80       	push   $0x80113d20
801042af:	56                   	push   %esi
801042b0:	e8 bb fe ff ff       	call   80104170 <sleep>
    havekids = 0;
801042b5:	83 c4 10             	add    $0x10,%esp
801042b8:	eb a4                	jmp    8010425e <wait+0x2e>
...
801042c6:	8b 73 10             	mov    0x10(%ebx),%esi
        kfree(p->kstack);
801042c9:	e8 a2 e1 ff ff       	call   80102470 <kfree>
        freevm(p->pgdir);
801042ce:	5a                   	pop    %edx
...
801042d2:	c7 43 08 00 00 00 00 	movl   $0x0,0x8(%ebx)
        freevm(p->pgdir);
801042d9:	e8 e2 31 00 00       	call   801074c0 <freevm>
        release(&ptable.lock);
...
801042fe:	c7 43 0c 00 00 00 00 	movl   $0x0,0xc(%ebx)
        release(&ptable.lock);
80104305:	e8 46 09 00 00       	call   80104c50 <release>
        return pid;
...
80104323:	e8 28 09 00 00       	call   80104c50 <release>
      return -1;
80104328:	83 c4 10             	add    $0x10,%esp
8010432b:	eb e0                	jmp    8010430d <wait+0xdd>
...
80104343:	e8 48 08 00 00       	call   80104b90 <acquire>
80104348:	83 c4 10             	add    $0x10,%esp
  for(p = ptable.proc; p < &ptable.proc[NPROC]; p++)
8010434b:	b8 54 3d 11 80       	mov    $0x80113d54,%eax
80104350:	eb 12                	jmp    80104364 <wakeup+0x34>
80104352:	8d b6 00 00 00 00    	lea    0x0(%esi),%esi
80104358:	05 dc 00 00 00       	add    $0xdc,%eax
8010435d:	3d 54 74 11 80       	cmp    $0x80117454,%eax
...
8010436f:	c7 40 0c 03 00 00 00 	movl   $0x3,0xc(%eax)
  for(p = ptable.proc; p < &ptable.proc[NPROC]; p++)
80104376:	05 dc 00 00 00       	add    $0xdc,%eax
8010437b:	3d 54 74 11 80       	cmp    $0x80117454,%eax
80104380:	75 e2                	jne    80104364 <wakeup+0x34>
  wakeup1(chan);
  release(&ptable.lock);
80104382:	c7 45 08 20 3d 11 80 	movl   $0x80113d20,0x8(%ebp)
}
80104389:	8b 5d fc             	mov    -0x4(%ebp),%ebx
8010438c:	c9                   	leave  
  release(&ptable.lock);
8010438d:	e9 be 08 00 00       	jmp    80104c50 <release>
...
801043b3:	e8 d8 07 00 00       	call   80104b90 <acquire>
801043b8:	83 c4 10             	add    $0x10,%esp
  for(p = ptable.proc; p < &ptable.proc[NPROC]; p++){
801043bb:	b8 54 3d 11 80       	mov    $0x80113d54,%eax
801043c0:	eb 12                	jmp    801043d4 <kill+0x34>
801043c2:	8d b6 00 00 00 00    	lea    0x0(%esi),%esi
801043c8:	05 dc 00 00 00       	add    $0xdc,%eax
801043cd:	3d 54 74 11 80       	cmp    $0x80117454,%eax
...
801043f0:	68 20 3d 11 80       	push   $0x80113d20
801043f5:	e8 56 08 00 00       	call   80104c50 <release>
      return 0;
    }
  }
  release(&ptable.lock);
...
80104410:	e8 3b 08 00 00       	call   80104c50 <release>
}
...
8010443d:	bb c0 3d 11 80       	mov    $0x80113dc0,%ebx
...
80104453:	68 03 83 10 80       	push   $0x80108303
80104458:	e8 53 c2 ff ff       	call   801006b0 <cprintf>
8010445d:	83 c4 10             	add    $0x10,%esp
  for(p = ptable.proc; p < &ptable.proc[NPROC]; p++){
80104460:	81 c3 dc 00 00 00    	add    $0xdc,%ebx
80104466:	81 fb c0 74 11 80    	cmp    $0x801174c0,%ebx
...
80104477:	74 e7                	je     80104460 <procdump+0x30>
      state = "???";
80104479:	ba cb 7d 10 80       	mov    $0x80107dcb,%edx
    if(p->state >= 0 && p->state < NELEM(states) && states[p->state])
8010447e:	83 f8 05             	cmp    $0x5,%eax
80104481:	77 11                	ja     80104494 <procdump+0x64>
80104483:	8b 14 85 ec 7f 10 80 	mov    -0x7fef8014(,%eax,4),%edx
      state = "???";
8010448a:	b8 cb 7d 10 80       	mov    $0x80107dcb,%eax
...
80104499:	68 cf 7d 10 80       	push   $0x80107dcf
...
801044c0:	e8 6b 05 00 00       	call   80104a30 <getcallerpcs>
      for(i=0; i<10 && pc[i] != 0; i++)
...
801044e1:	68 21 78 10 80       	push   $0x80107821
...
80104518:	53                   	push   %ebx
  pushcli();
80104519:	e8 72 05 00 00       	call   80104a90 <pushcli>
  c = mycpu();
8010451e:	e8 4d f4 ff ff       	call   80103970 <mycpu>
  p = c->proc;
80104523:	8b b0 ac 00 00 00    	mov    0xac(%eax),%esi
  popcli();
80104529:	e8 b2 05 00 00       	call   80104ae0 <popcli>
  struct proc *p;
  int havekids, pid;
  struct proc *curproc = myproc();
...
80104531:	68 20 3d 11 80       	push   $0x80113d20
80104536:	e8 55 06 00 00       	call   80104b90 <acquire>
...
8010453e:	31 c0                	xor    %eax,%eax
    for(p = ptable.proc; p < &ptable.proc[NPROC]; p++){
80104540:	bb 54 3d 11 80       	mov    $0x80113d54,%ebx
80104545:	eb 17                	jmp    8010455e <waitx+0x4e>
80104547:	8d b4 26 00 00 00 00 	lea    0x0(%esi,%eiz,1),%esi
8010454e:	66 90                	xchg   %ax,%ax
80104550:	81 c3 dc 00 00 00    	add    $0xdc,%ebx
80104556:	81 fb 54 74 11 80    	cmp    $0x80117454,%ebx
...
80104567:	74 3f                	je     801045a8 <waitx+0x98>
    for(p = ptable.proc; p < &ptable.proc[NPROC]; p++){
80104569:	81 c3 dc 00 00 00    	add    $0xdc,%ebx
      havekids = 1;
8010456f:	b8 01 00 00 00       	mov    $0x1,%eax
    for(p = ptable.proc; p < &ptable.proc[NPROC]; p++){
80104574:	81 fb 54 74 11 80    	cmp    $0x80117454,%ebx
...
8010457e:	0f 84 ad 00 00 00    	je     80104631 <waitx+0x121>
80104584:	8b 46 24             	mov    0x24(%esi),%eax
80104587:	85 c0                	test   %eax,%eax
80104589:	0f 85 a2 00 00 00    	jne    80104631 <waitx+0x121>
      release(&ptable.lock);
      return -1;
    }
...
80104598:	e8 d3 fb ff ff       	call   80104170 <sleep>
    havekids = 0;
...
801045ab:	ff 73 08             	pushl  0x8(%ebx)
        pid = p->pid;
801045ae:	8b 73 10             	mov    0x10(%ebx),%esi
        kfree(p->kstack);
801045b1:	e8 ba de ff ff       	call   80102470 <kfree>
        freevm(p->pgdir);
801045b6:	5a                   	pop    %edx
801045b7:	ff 73 04             	pushl  0x4(%ebx)
        p->kstack = 0;
801045ba:	c7 43 08 00 00 00 00 	movl   $0x0,0x8(%ebx)
        freevm(p->pgdir);
801045c1:	e8 fa 2e 00 00       	call   801074c0 <freevm>
        release(&ptable.lock);
...
801045e6:	c7 43 0c 00 00 00 00 	movl   $0x0,0xc(%ebx)
        release(&ptable.lock);
801045ed:	e8 5e 06 00 00       	call   80104c50 <release>
        *waittime = (p->etime - p->ctime - p->runtime);
801045f2:	8b 55 08             	mov    0x8(%ebp),%edx
801045f5:	8b 83 90 00 00 00    	mov    0x90(%ebx),%eax
        return pid;
801045fb:	83 c4 10             	add    $0x10,%esp
        *waittime = (p->etime - p->ctime - p->runtime);
801045fe:	2b 83 8c 00 00 00    	sub    0x8c(%ebx),%eax
80104604:	2b 83 80 00 00 00    	sub    0x80(%ebx),%eax
8010460a:	89 02                	mov    %eax,(%edx)
	      p->rtime =  p->runtime + p->waittime + p->iowaittime;
8010460c:	8b 93 80 00 00 00    	mov    0x80(%ebx),%edx
80104612:	8b 83 88 00 00 00    	mov    0x88(%ebx),%eax
80104618:	01 d0                	add    %edx,%eax
8010461a:	03 83 98 00 00 00    	add    0x98(%ebx),%eax
80104620:	89 43 7c             	mov    %eax,0x7c(%ebx)
        *runtime = p->runtime;
80104623:	8b 45 0c             	mov    0xc(%ebp),%eax
80104626:	89 10                	mov    %edx,(%eax)
  }
}
80104628:	8d 65 f8             	lea    -0x8(%ebp),%esp
8010462b:	89 f0                	mov    %esi,%eax
8010462d:	5b                   	pop    %ebx
8010462e:	5e                   	pop    %esi
8010462f:	5d                   	pop    %ebp
80104630:	c3                   	ret    
...
80104634:	be ff ff ff ff       	mov    $0xffffffff,%esi
      release(&ptable.lock);
80104639:	68 20 3d 11 80       	push   $0x80113d20
8010463e:	e8 0d 06 00 00       	call   80104c50 <release>
      return -1;
80104643:	83 c4 10             	add    $0x10,%esp
80104646:	eb e0                	jmp    80104628 <waitx+0x118>
80104648:	8d b4 26 00 00 00 00 	lea    0x0(%esi,%eiz,1),%esi
8010464f:	90                   	nop

80104650 <set_priority>:
...
8010465f:	83 fb 64             	cmp    $0x64,%ebx
80104662:	0f 87 7f 00 00 00    	ja     801046e7 <set_priority+0x97>
    return -1;
  }
  int find = 0;
  int rt = -1;
...
80104670:	e8 1b 05 00 00       	call   80104b90 <acquire>
80104675:	83 c4 10             	add    $0x10,%esp

  for (p = ptable.proc; p < &ptable.proc[NPROC]; p++)
80104678:	b8 54 3d 11 80       	mov    $0x80113d54,%eax
8010467d:	eb 0d                	jmp    8010468c <set_priority+0x3c>
8010467f:	90                   	nop
80104680:	05 dc 00 00 00       	add    $0xdc,%eax
80104685:	3d 54 74 11 80       	cmp    $0x80117454,%eax
8010468a:	74 3c                	je     801046c8 <set_priority+0x78>
  {
    if(p->pid!=0)
8010468c:	8b 50 10             	mov    0x10(%eax),%edx
 //   cprintf("Pids present are %d\n",p->pid);
    if(pid == p->pid)
8010468f:	39 f2                	cmp    %esi,%edx
80104691:	75 ed                	jne    80104680 <set_priority+0x30>
80104693:	85 d2                	test   %edx,%edx
80104695:	74 e9                	je     80104680 <set_priority+0x30>
      rt = p->priority;
...
80104697:	83 ec 0c             	sub    $0xc,%esp
      rt = p->priority;
8010469a:	8b b0 94 00 00 00    	mov    0x94(%eax),%esi
      p->priority = new_priority;
801046a0:	89 98 94 00 00 00    	mov    %ebx,0x94(%eax)
  release(&ptable.lock);
801046a6:	68 20 3d 11 80       	push   $0x80113d20
801046ab:	e8 a0 05 00 00       	call   80104c50 <release>
  if(rt > new_priority)
801046b0:	83 c4 10             	add    $0x10,%esp
801046b3:	39 f3                	cmp    %esi,%ebx
801046b5:	7d 05                	jge    801046bc <set_priority+0x6c>
  {
  	yield();
801046b7:	e8 64 fa ff ff       	call   80104120 <yield>
  else
  {
    return -1;
  }
...
801046d0:	e8 7b 05 00 00       	call   80104c50 <release>
	  cprintf("The process with given pid = %d  is not yet created or exited earlier\n",pid,new_priority);
801046d5:	83 c4 0c             	add    $0xc,%esp
801046d8:	53                   	push   %ebx
801046d9:	56                   	push   %esi
801046da:	68 2c 7e 10 80       	push   $0x80107e2c
801046df:	e8 cc bf ff ff       	call   801006b0 <cprintf>
	  return -1;
801046e4:	83 c4 10             	add    $0x10,%esp
}
801046e7:	8d 65 f8             	lea    -0x8(%ebp),%esp
	  return -1;
801046ea:	be ff ff ff ff       	mov    $0xffffffff,%esi
}
801046ef:	89 f0                	mov    %esi,%eax
801046f1:	5b                   	pop    %ebx
801046f2:	5e                   	pop    %esi
801046f3:	5d                   	pop    %ebp
801046f4:	c3                   	ret    
801046f5:	8d b4 26 00 00 00 00 	lea    0x0(%esi,%eiz,1),%esi
...
8010470d:	83 ec 10             	sub    $0x10,%esp
  acquire(&ptable.lock);
80104710:	68 20 3d 11 80       	push   $0x80113d20
80104715:	e8 76 04 00 00       	call   80104b90 <acquire>
  cprintf("PID \t Priority \t State \t \t r_time \t w_time \t n_run \t cur_q \t q0 \t q1 \t q2 \t q3 \t q4 \n");
8010471a:	c7 04 24 74 7e 10 80 	movl   $0x80107e74,(%esp)
80104721:	e8 8a bf ff ff       	call   801006b0 <cprintf>
80104726:	83 c4 10             	add    $0x10,%esp
80104729:	eb 2e                	jmp    80104759 <ps+0x59>
...
80104730:	83 f8 04             	cmp    $0x4,%eax
80104733:	0f 84 87 00 00 00    	je     801047c0 <ps+0xc0>
      cprintf("%d \t %d \t \t running \t %d \t \t %d \t \t %d \t %d \t %d \t %d \t %d \t %d \t %d\n", p->pid, p->priority, p->runtime, p->waittime, p->n_run,p->cur_q,p->q[0],p->q[1],p->q[2],p->q[3],p->q[4]);
    else if (p->state == RUNNABLE)
80104739:	83 f8 03             	cmp    $0x3,%eax
8010473c:	0f 84 d6 00 00 00    	je     80104818 <ps+0x118>
      cprintf("%d \t %d \t \t runnable \t %d \t \t %d \t \t %d \t %d \t %d \t %d \t %d \t %d \t %d\n", p->pid, p->priority, p->runtime, p->waittime, p->n_run,p->cur_q,p->q[0],p->q[1],p->q[2],p->q[3],p->q[4]);
    else if(p->state == ZOMBIE)
80104742:	83 f8 05             	cmp    $0x5,%eax
80104745:	0f 84 25 01 00 00    	je     80104870 <ps+0x170>
  for(p = ptable.proc; p < &ptable.proc[NPROC]; p++)
8010474b:	81 c3 dc 00 00 00    	add    $0xdc,%ebx
80104751:	81 fb 54 74 11 80    	cmp    $0x80117454,%ebx
80104757:	74 4a                	je     801047a3 <ps+0xa3>
    if (p->state == SLEEPING)
80104759:	8b 43 0c             	mov    0xc(%ebx),%eax
8010475c:	83 f8 02             	cmp    $0x2,%eax
8010475f:	75 cf                	jne    80104730 <ps+0x30>
      cprintf("%d \t %d \t \t sleeping \t %d \t \t %d \t \t %d \t %d \t %d \t %d \t %d \t %d \t %d\n", p->pid, p->priority, p->runtime, p->waittime, p->n_run,p->cur_q,p->q[0],p->q[1],p->q[2],p->q[3],p->q[4]);
80104761:	ff b3 ac 00 00 00    	pushl  0xac(%ebx)
  for(p = ptable.proc; p < &ptable.proc[NPROC]; p++)
80104767:	81 c3 dc 00 00 00    	add    $0xdc,%ebx
      cprintf("%d \t %d \t \t sleeping \t %d \t \t %d \t \t %d \t %d \t %d \t %d \t %d \t %d \t %d\n", p->pid, p->priority, p->runtime, p->waittime, p->n_run,p->cur_q,p->q[0],p->q[1],p->q[2],p->q[3],p->q[4]);
8010476d:	ff 73 cc             	pushl  -0x34(%ebx)
80104770:	ff 73 c8             	pushl  -0x38(%ebx)
80104773:	ff 73 c4             	pushl  -0x3c(%ebx)
80104776:	ff 73 c0             	pushl  -0x40(%ebx)
80104779:	ff 73 d8             	pushl  -0x28(%ebx)
8010477c:	ff 73 dc             	pushl  -0x24(%ebx)
8010477f:	ff 73 ac             	pushl  -0x54(%ebx)
80104782:	ff 73 a4             	pushl  -0x5c(%ebx)
80104785:	ff 73 b8             	pushl  -0x48(%ebx)
80104788:	ff b3 34 ff ff ff    	pushl  -0xcc(%ebx)
8010478e:	68 cc 7e 10 80       	push   $0x80107ecc
80104793:	e8 18 bf ff ff       	call   801006b0 <cprintf>
80104798:	83 c4 30             	add    $0x30,%esp
  for(p = ptable.proc; p < &ptable.proc[NPROC]; p++)
8010479b:	81 fb 54 74 11 80    	cmp    $0x80117454,%ebx
801047a1:	75 b6                	jne    80104759 <ps+0x59>
      cprintf("%d \t %d \t \t zombie \t %d \t \t %d \t \t %d \t %d \t %d \t %d \t %d \t %d \t %d\n", p->pid, p->priority, p->runtime, p->waittime, p->n_run,p->cur_q,p->q[0],p->q[1],p->q[2],p->q[3],p->q[4]);

  }
  release(&ptable.lock);
801047a3:	83 ec 0c             	sub    $0xc,%esp
801047a6:	68 20 3d 11 80       	push   $0x80113d20
801047ab:	e8 a0 04 00 00       	call   80104c50 <release>
  return 24;
}
801047b0:	8b 5d fc             	mov    -0x4(%ebp),%ebx
801047b3:	b8 18 00 00 00       	mov    $0x18,%eax
801047b8:	c9                   	leave  
801047b9:	c3                   	ret    
801047ba:	8d b6 00 00 00 00    	lea    0x0(%esi),%esi
      cprintf("%d \t %d \t \t running \t %d \t \t %d \t \t %d \t %d \t %d \t %d \t %d \t %d \t %d\n", p->pid, p->priority, p->runtime, p->waittime, p->n_run,p->cur_q,p->q[0],p->q[1],p->q[2],p->q[3],p->q[4]);
801047c0:	ff b3 ac 00 00 00    	pushl  0xac(%ebx)
801047c6:	ff b3 a8 00 00 00    	pushl  0xa8(%ebx)
...
801047de:	ff b3 b4 00 00 00    	pushl  0xb4(%ebx)
801047e4:	ff b3 b8 00 00 00    	pushl  0xb8(%ebx)
801047ea:	ff b3 88 00 00 00    	pushl  0x88(%ebx)
801047f0:	ff b3 80 00 00 00    	pushl  0x80(%ebx)
801047f6:	ff b3 94 00 00 00    	pushl  0x94(%ebx)
801047fc:	ff 73 10             	pushl  0x10(%ebx)
801047ff:	68 14 7f 10 80       	push   $0x80107f14
80104804:	e8 a7 be ff ff       	call   801006b0 <cprintf>
80104809:	83 c4 30             	add    $0x30,%esp
8010480c:	e9 3a ff ff ff       	jmp    8010474b <ps+0x4b>
80104811:	8d b4 26 00 00 00 00 	lea    0x0(%esi,%eiz,1),%esi
      cprintf("%d \t %d \t \t runnable \t %d \t \t %d \t \t %d \t %d \t %d \t %d \t %d \t %d \t %d\n", p->pid, p->priority, p->runtime, p->waittime, p->n_run,p->cur_q,p->q[0],p->q[1],p->q[2],p->q[3],p->q[4]);
80104818:	ff b3 ac 00 00 00    	pushl  0xac(%ebx)
8010481e:	ff b3 a8 00 00 00    	pushl  0xa8(%ebx)
80104824:	ff b3 a4 00 00 00    	pushl  0xa4(%ebx)
8010482a:	ff b3 a0 00 00 00    	pushl  0xa0(%ebx)
80104830:	ff b3 9c 00 00 00    	pushl  0x9c(%ebx)
80104836:	ff b3 b4 00 00 00    	pushl  0xb4(%ebx)
8010483c:	ff b3 b8 00 00 00    	pushl  0xb8(%ebx)
80104842:	ff b3 88 00 00 00    	pushl  0x88(%ebx)
80104848:	ff b3 80 00 00 00    	pushl  0x80(%ebx)
8010484e:	ff b3 94 00 00 00    	pushl  0x94(%ebx)
80104854:	ff 73 10             	pushl  0x10(%ebx)
80104857:	68 5c 7f 10 80       	push   $0x80107f5c
8010485c:	e8 4f be ff ff       	call   801006b0 <cprintf>
80104861:	83 c4 30             	add    $0x30,%esp
80104864:	e9 e2 fe ff ff       	jmp    8010474b <ps+0x4b>
80104869:	8d b4 26 00 00 00 00 	lea    0x0(%esi,%eiz,1),%esi
      cprintf("%d \t %d \t \t zombie \t %d \t \t %d \t \t %d \t %d \t %d \t %d \t %d \t %d \t %d\n", p->pid, p->priority, p->runtime, p->waittime, p->n_run,p->cur_q,p->q[0],p->q[1],p->q[2],p->q[3],p->q[4]);
80104870:	ff b3 ac 00 00 00    	pushl  0xac(%ebx)
80104876:	ff b3 a8 00 00 00    	pushl  0xa8(%ebx)
8010487c:	ff b3 a4 00 00 00    	pushl  0xa4(%ebx)
80104882:	ff b3 a0 00 00 00    	pushl  0xa0(%ebx)
80104888:	ff b3 9c 00 00 00    	pushl  0x9c(%ebx)
8010488e:	ff b3 b4 00 00 00    	pushl  0xb4(%ebx)
80104894:	ff b3 b8 00 00 00    	pushl  0xb8(%ebx)
8010489a:	ff b3 88 00 00 00    	pushl  0x88(%ebx)
801048a0:	ff b3 80 00 00 00    	pushl  0x80(%ebx)
801048a6:	ff b3 94 00 00 00    	pushl  0x94(%ebx)
801048ac:	ff 73 10             	pushl  0x10(%ebx)
801048af:	68 a4 7f 10 80       	push   $0x80107fa4
801048b4:	e8 f7 bd ff ff       	call   801006b0 <cprintf>
801048b9:	83 c4 30             	add    $0x30,%esp
801048bc:	e9 8a fe ff ff       	jmp    8010474b <ps+0x4b>
801048c1:	66 90                	xchg   %ax,%ax
801048c3:	66 90                	xchg   %ax,%ax
...
801048de:	68 04 80 10 80       	push   $0x80108004
...
8010494b:	c7 03 01 00 00 00    	movl   $0x1,(%ebx)
  lk->pid = myproc()->pid;
80104951:	e8 aa f0 ff ff       	call   80103a00 <myproc>
...
80104998:	e8 93 f9 ff ff       	call   80104330 <wakeup>
  release(&lk->lk);
...
801049f3:	e8 08 f0 ff ff       	call   80103a00 <myproc>
...
80104a9d:	fa                   	cli    
  ...
  cli();
  if(mycpu()->ncli == 0)
80104a9e:	e8 cd ee ff ff       	call   80103970 <mycpu>
...
80104abf:	90                   	nop
    mycpu()->intena = eflags & FL_IF;
80104ac0:	e8 ab ee ff ff       	call   80103970 <mycpu>
...
80104b0f:	c3                   	ret    
  if(mycpu()->ncli == 0 && mycpu()->intena)
80104b10:	e8 5b ee ff ff       	call   80103970 <mycpu>
...
80104b25:	68 0f 80 10 80       	push   $0x8010800f
80104b2a:	e8 61 b8 ff ff       	call   80100390 <panic>
    panic("popcli");
80104b2f:	83 ec 0c             	sub    $0xc,%esp
80104b32:	68 26 80 10 80       	push   $0x80108026
...
80104bd4:	e8 97 ed ff ff       	call   80103970 <mycpu>
...
80104c37:	68 2d 80 10 80       	push   $0x8010802d
...
80104c90:	68 35 80 10 80       	push   $0x80108035
...
80104eeb:	8b 5d 08             	mov    0x8(%ebp),%ebx
  struct proc *curproc = myproc();
80104eee:	e8 0d eb ff ff       	call   80103a00 <myproc>
...
80104f2b:	8b 5d 08             	mov    0x8(%ebp),%ebx
  char *s, *ep;
  struct proc *curproc = myproc();
80104f2e:	e8 cd ea ff ff       	call   80103a00 <myproc>
...
80104f89:	e8 72 ea ff ff       	call   80103a00 <myproc>
...
80104f97:	8d 1c 90             	lea    (%eax,%edx,4),%ebx
  struct proc *curproc = myproc();
80104f9a:	e8 61 ea ff ff       	call   80103a00 <myproc>
  return fetchint((myproc()->tf->esp) + 4 + 4*n, ip);
...
80104fdc:	8b 5d 10             	mov    0x10(%ebp),%ebx
  int i;
  struct proc *curproc = myproc();
80104fdf:	e8 1c ea ff ff       	call   80103a00 <myproc>
...
80105078:	83 ec 04             	sub    $0x4,%esp
  int num;
  struct proc *curproc = myproc();
8010507b:	e8 80 e9 ff ff       	call   80103a00 <myproc>
...
80105090:	8b 14 85 60 80 10 80 	mov    -0x7fef7fa0(,%eax,4),%edx
...
801050b8:	68 3d 80 10 80       	push   $0x8010803d
...
80105214:	68 e0 80 10 80       	push   $0x801080e0
...
8010522c:	68 df 80 10 80       	push   $0x801080df
...
80105241:	68 d3 80 10 80       	push   $0x801080d3
...
8010525f:	68 e2 80 10 80       	push   $0x801080e2
80105264:	e8 27 b1 ff ff       	call   80100390 <panic>
    panic("create: ialloc");
80105269:	83 ec 0c             	sub    $0xc,%esp
8010526c:	68 c4 80 10 80       	push   $0x801080c4
...
801052a4:	e8 57 e7 ff ff       	call   80103a00 <myproc>
...
801052ed:	31 db                	xor    %ebx,%ebx
  struct proc *curproc = myproc();
801052ef:	e8 0c e7 ff ff       	call   80103a00 <myproc>
  for(fd = 0; fd < NOFILE; fd++){
...
80105437:	78 27                	js     80105460 <sys_close+0x40>
  myproc()->ofile[fd] = 0;
80105439:	e8 c2 e5 ff ff       	call   80103a00 <myproc>
...
8010565d:	58                   	pop    %eax
8010565e:	5a                   	pop    %edx
8010565f:	68 e0 80 10 80       	push   $0x801080e0
...
80105678:	68 df 80 10 80       	push   $0x801080df
...
80105867:	74 23                	je     8010588c <sys_open+0x9c>
  struct proc *curproc = myproc();
80105869:	e8 92 e1 ff ff       	call   80103a00 <myproc>
  for(fd = 0; fd < NOFILE; fd++){
...
80105a49:	83 ec 10             	sub    $0x10,%esp
  ...
  struct inode *ip;
  struct proc *curproc = myproc();
80105a4c:	e8 af df ff ff       	call   80103a00 <myproc>
...
80105c2b:	31 db                	xor    %ebx,%ebx
  struct proc *curproc = myproc();
80105c2d:	e8 ce dd ff ff       	call   80103a00 <myproc>
  for(fd = 0; fd < NOFILE; fd++){
...
80105c77:	8b 7d e4             	mov    -0x1c(%ebp),%edi
  struct proc *curproc = myproc();
80105c7a:	e8 81 dd ff ff       	call   80103a00 <myproc>
  for(fd = 0; fd < NOFILE; fd++){
...
80105c96:	75 f0                	jne    80105c88 <sys_pipe+0x98>
      myproc()->ofile[fd0] = 0;
80105c98:	e8 63 dd ff ff       	call   80103a00 <myproc>
...
80105cd0:	f3 0f 1e fb          	endbr32 
  return fork();
80105cd4:	e9 d7 de ff ff       	jmp    80103bb0 <fork>
...
80105ce7:	83 ec 08             	sub    $0x8,%esp
  exit();
80105cea:	e8 d1 e2 ff ff       	call   80103fc0 <exit>
...
80105d00:	f3 0f 1e fb          	endbr32 
  return wait();
80105d04:	e9 27 e5 ff ff       	jmp    80104230 <wait>
...
80105d32:	e8 69 e6 ff ff       	call   801043a0 <kill>
...
80105d57:	83 ec 08             	sub    $0x8,%esp
  return myproc()->pid;
80105d5a:	e8 a1 dc ff ff       	call   80103a00 <myproc>
...
80105d8b:	78 23                	js     80105db0 <sys_sbrk+0x40>
    return -1;
  addr = myproc()->sz;
80105d8d:	e8 6e dc ff ff       	call   80103a00 <myproc>
  if(growproc(n) < 0)
...
80105d9a:	e8 91 dd ff ff       	call   80103b30 <growproc>
...
80105de4:	68 60 74 11 80       	push   $0x80117460
80105de9:	e8 a2 ed ff ff       	call   80104b90 <acquire>
  ticks0 = ticks;
  while(ticks - ticks0 < n){
80105dee:	8b 55 f4             	mov    -0xc(%ebp),%edx
  ticks0 = ticks;
80105df1:	8b 1d a0 7c 11 80    	mov    0x80117ca0,%ebx
  while(ticks - ticks0 < n){
...
80105e03:	68 60 74 11 80       	push   $0x80117460
80105e08:	68 a0 7c 11 80       	push   $0x80117ca0
80105e0d:	e8 5e e3 ff ff       	call   80104170 <sleep>
  while(ticks - ticks0 < n){
80105e12:	a1 a0 7c 11 80       	mov    0x80117ca0,%eax
...
80105e1f:	73 2f                	jae    80105e50 <sys_sleep+0x90>
    if(myproc()->killed){
80105e21:	e8 da db ff ff       	call   80103a00 <myproc>
...
80105e30:	68 60 74 11 80       	push   $0x80117460
...
80105e53:	68 60 74 11 80       	push   $0x80117460
...
80105e78:	83 ec 10             	sub    $0x10,%esp
  ...
  acquire(&tickslock);
80105e7b:	68 60 74 11 80       	push   $0x80117460
80105e80:	e8 0b ed ff ff       	call   80104b90 <acquire>
  xticks = ticks;
80105e85:	8b 1d a0 7c 11 80    	mov    0x80117ca0,%ebx
  release(&tickslock);
80105e8b:	c7 04 24 60 74 11 80 	movl   $0x80117460,(%esp)
...
80105eba:	89 c2                	mov    %eax,%edx
          return 90;
80105ebc:	b8 5a 00 00 00       	mov    $0x5a,%eax
      if(argptr(0, (char**)&waittime, sizeof(int)) < 0)
80105ec1:	85 d2                	test   %edx,%edx
80105ec3:	78 2f                	js     80105ef4 <sys_waitx+0x54>
...
80105ed0:	e8 fb f0 ff ff       	call   80104fd0 <argptr>
80105ed5:	83 c4 10             	add    $0x10,%esp
80105ed8:	89 c2                	mov    %eax,%edx
          return 91;
80105eda:	b8 5b 00 00 00       	mov    $0x5b,%eax
      if(argptr(1, (char**)&runtime, sizeof(int)) < 0)
80105edf:	85 d2                	test   %edx,%edx
80105ee1:	78 11                	js     80105ef4 <sys_waitx+0x54>
...
80105eec:	e8 1f e6 ff ff       	call   80104510 <waitx>
...
80105f3a:	e8 11 e7 ff ff       	call   80104650 <set_priority>
...
80105f50:	f3 0f 1e fb          	endbr32 
  return ps();
80105f54:	e9 a7 e7 ff ff       	jmp    80104700 <ps>
...
80105f97:	c7 04 c5 a2 74 11 80 	movl   $0x8e000008,-0x7fee8b5e(,%eax,8)
80105f9e:	08 00 00 8e 
80105fa2:	66 89 14 c5 a0 74 11 	mov    %dx,-0x7fee8b60(,%eax,8)
80105fa9:	80 
80105faa:	c1 ea 10             	shr    $0x10,%edx
80105fad:	66 89 14 c5 a6 74 11 	mov    %dx,-0x7fee8b5a(,%eax,8)
80105fb4:	80 
	for(i = 0; i < 256; i++)
...
80105fc7:	c7 05 a2 76 11 80 08 	movl   $0xef000008,0x801176a2
80105fce:	00 00 ef 
	initlock(&tickslock, "time");
80105fd1:	68 25 81 10 80       	push   $0x80108125
80105fd6:	68 60 74 11 80       	push   $0x80117460
	SETGATE(idt[T_SYSCALL], 1, SEG_KCODE<<3, vectors[T_SYSCALL], DPL_USER);
80105fdb:	66 a3 a0 76 11 80    	mov    %ax,0x801176a0
80105fe1:	c1 e8 10             	shr    $0x10,%eax
80105fe4:	66 a3 a6 76 11 80    	mov    %ax,0x801176a6
	initlock(&tickslock, "time");
...
8010600f:	66 89 45 fa          	mov    %ax,-0x6(%ebp)
  pd[1] = (uint)p;
80106013:	b8 a0 74 11 80       	mov    $0x801174a0,%eax
...
80106054:	3e ff 24 85 cc 81 10 	notrack jmp *-0x7fef7e34(,%eax,4)
8010605b:	80 
			lapiceoi();
			break;
...
8010605c:	e8 9f d9 ff ff       	call   80103a00 <myproc>
...
8010607c:	e8 5f d9 ff ff       	call   801039e0 <cpuid>
...
8010608d:	e8 6e d9 ff ff       	call   80103a00 <myproc>
80106092:	89 45 e0             	mov    %eax,-0x20(%ebp)
80106095:	e8 66 d9 ff ff       	call   80103a00 <myproc>
			cprintf("pid %d %s: trap %d err %d on cpu %d "
...
801060b1:	68 88 81 10 80       	push   $0x80108188
801060b6:	e8 f5 a5 ff ff       	call   801006b0 <cprintf>
					tf->err, cpuid(), tf->eip, rcr2());
			myproc()->killed = 1;
801060bb:	83 c4 20             	add    $0x20,%esp
801060be:	e8 3d d9 ff ff       	call   80103a00 <myproc>
...
801060ca:	e8 31 d9 ff ff       	call   80103a00 <myproc>
801060cf:	85 c0                	test   %eax,%eax
801060d1:	74 1d                	je     801060f0 <trap+0xc0>
801060d3:	e8 28 d9 ff ff       	call   80103a00 <myproc>
...
801060f0:	e8 0b d9 ff ff       	call   80103a00 <myproc>
801060f5:	85 c0                	test   %eax,%eax
801060f7:	74 0f                	je     80106108 <trap+0xd8>
801060f9:	e8 02 d9 ff ff       	call   80103a00 <myproc>
...
80106102:	0f 84 f0 00 00 00    	je     801061f8 <trap+0x1c8>
	...
	if(myproc() && myproc()->killed && (tf->cs&3) == DPL_USER)
80106108:	e8 f3 d8 ff ff       	call   80103a00 <myproc>
8010610d:	85 c0                	test   %eax,%eax
8010610f:	74 1d                	je     8010612e <trap+0xfe>
80106111:	e8 ea d8 ff ff       	call   80103a00 <myproc>
...
8010613b:	e8 80 c7 ff ff       	call   801028c0 <lapiceoi>
	if(myproc() && myproc()->killed && (tf->cs&3) == DPL_USER)
80106140:	e8 bb d8 ff ff       	call   80103a00 <myproc>
80106145:	85 c0                	test   %eax,%eax
80106147:	75 8a                	jne    801060d3 <trap+0xa3>
80106149:	eb a5                	jmp    801060f0 <trap+0xc0>
			if(cpuid() == 0){
8010614b:	e8 90 d8 ff ff       	call   801039e0 <cpuid>
80106150:	85 c0                	test   %eax,%eax
80106152:	75 e7                	jne    8010613b <trap+0x10b>
				acquire(&tickslock);
80106154:	83 ec 0c             	sub    $0xc,%esp
80106157:	68 60 74 11 80       	push   $0x80117460
8010615c:	e8 2f ea ff ff       	call   80104b90 <acquire>
				wakeup(&ticks);
80106161:	c7 04 24 a0 7c 11 80 	movl   $0x80117ca0,(%esp)
				ticks++;
80106168:	83 05 a0 7c 11 80 01 	addl   $0x1,0x80117ca0
				wakeup(&ticks);
8010616f:	e8 bc e1 ff ff       	call   80104330 <wakeup>
				release(&tickslock);
80106174:	c7 04 24 60 74 11 80 	movl   $0x80117460,(%esp)
8010617b:	e8 d0 ea ff ff       	call   80104c50 <release>
				updateruntime();
80106180:	e8 0b dc ff ff       	call   80103d90 <updateruntime>
...
8010618f:	e8 2c c7 ff ff       	call   801028c0 <lapiceoi>
	if(myproc() && myproc()->killed && (tf->cs&3) == DPL_USER)
80106194:	e8 67 d8 ff ff       	call   80103a00 <myproc>
...
801061ab:	e8 10 c7 ff ff       	call   801028c0 <lapiceoi>
	if(myproc() && myproc()->killed && (tf->cs&3) == DPL_USER)
801061b0:	e8 4b d8 ff ff       	call   80103a00 <myproc>
...
801061c9:	e8 12 d8 ff ff       	call   801039e0 <cpuid>
801061ce:	57                   	push   %edi
801061cf:	56                   	push   %esi
801061d0:	50                   	push   %eax
801061d1:	68 30 81 10 80       	push   $0x80108130
...
801061e0:	83 c4 10             	add    $0x10,%esp
	if(myproc() && myproc()->killed && (tf->cs&3) == DPL_USER)
801061e3:	e8 18 d8 ff ff       	call   80103a00 <myproc>
...
80106270:	68 54 81 10 80       	push   $0x80108154
80106275:	e8 36 a4 ff ff       	call   801006b0 <cprintf>
				panic("trap");
8010627a:	83 c4 14             	add    $0x14,%esp
8010627d:	68 2a 81 10 80       	push   $0x8010812a
...
80106383:	be 76 00 00 00       	mov    $0x76,%esi
  for(p="xv6...\n"; *p; p++)
80106388:	bb 4c 82 10 80       	mov    $0x8010824c,%ebx
  ioapicenable(IRQ_COM1, 0);
...
80106f8d:	68 54 82 10 80       	push   $0x80108254
...
80107057:	83 ec 18             	sub    $0x18,%esp
  c = &cpus[cpuid()];
8010705a:	e8 81 c9 ff ff       	call   801039e0 <cpuid>
  pd[0] = size-1;
...
801070e4:	a1 a4 7c 11 80       	mov    0x80117ca4,%eax
...
80107133:	e8 38 c8 ff ff       	call   80103970 <mycpu>
80107138:	89 c3                	mov    %eax,%ebx
8010713a:	e8 31 c8 ff ff       	call   80103970 <mycpu>
8010713f:	89 c7                	mov    %eax,%edi
80107141:	e8 2a c8 ff ff       	call   80103970 <mycpu>
80107146:	83 c7 08             	add    $0x8,%edi
80107149:	89 45 e4             	mov    %eax,-0x1c(%ebp)
8010714c:	e8 1f c8 ff ff       	call   80103970 <mycpu>
...
8010727f:	68 99 82 10 80       	push   $0x80108299
...
801073e9:	68 d1 82 10 80       	push   $0x801082d1
...
8010744b:	68 e9 82 10 80       	push   $0x801082e9
...
8010752c:	68 05 83 10 80       	push   $0x80108305
...
801075cf:	a3 a4 7c 11 80       	mov    %eax,0x80117ca4
  lcr3(V2P(kpgdir));   // switch to the kernel page table
...
80107603:	68 16 83 10 80       	push   $0x80108316
...
801076e9:	68 3a 83 10 80       	push   $0x8010833a
801076ee:	e8 9d 8c ff ff       	call   80100390 <panic>
      panic("copyuvm: pte should exist");
801076f3:	83 ec 0c             	sub    $0xc,%esp
801076f6:	68 20 83 10 80       	push   $0x80108320
