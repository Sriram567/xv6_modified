  ...
  16:	c7 45 f0 00 00 00 00 	movl   $0x0,-0x10(%ebp)
{
  ...
  20:	c7 45 f4 00 00 00 00 	movl   $0x0,-0xc(%ebp)
	...
	pid = fork();
  27:	e8 bf 02 00 00       	call   2eb <fork>

	if(pid < 0)
  2c:	85 c0                	test   %eax,%eax
  2e:	78 3e                	js     6e <main+0x6e>
	{
		printf(1,"fork failed\n");
	}
	else if(pid == 0)
  30:	74 29                	je     5b <main+0x5b>
		exec(argv[1], argv+1);
	}
	else
	{
//		status  =
  ...
  32:	50                   	push   %eax
  33:	50                   	push   %eax
  34:	8d 45 f4             	lea    -0xc(%ebp),%eax
  37:	50                   	push   %eax
  38:	8d 45 f0             	lea    -0x10(%ebp),%eax
  3b:	50                   	push   %eax
  3c:	e8 52 03 00 00       	call   393 <waitx>

		printf(1, "The process WAIT TIME = %d RUN TIME = %d\n ", waittime, runtime);
  41:	ff 75 f4             	pushl  -0xc(%ebp)
  44:	ff 75 f0             	pushl  -0x10(%ebp)
  47:	68 d8 07 00 00       	push   $0x7d8
  4c:	6a 01                	push   $0x1
  4e:	e8 0d 04 00 00       	call   460 <printf>
  53:	83 c4 20             	add    $0x20,%esp
	}
	exit();
  56:	e8 98 02 00 00       	call   2f3 <exit>
		exec(argv[1], argv+1);
  5b:	8d 43 04             	lea    0x4(%ebx),%eax
  5e:	52                   	push   %edx
  5f:	52                   	push   %edx
  60:	50                   	push   %eax
  61:	ff 73 04             	pushl  0x4(%ebx)
  64:	e8 c2 02 00 00       	call   32b <exec>
  69:	83 c4 10             	add    $0x10,%esp
  6c:	eb e8                	jmp    56 <main+0x56>
		printf(1,"fork failed\n");
  6e:	51                   	push   %ecx
  6f:	51                   	push   %ecx
  70:	68 c8 07 00 00       	push   $0x7c8
  75:	6a 01                	push   $0x1
  77:	e8 e4 03 00 00       	call   460 <printf>
  7c:	83 c4 10             	add    $0x10,%esp
  7f:	eb d5                	jmp    56 <main+0x56>
  81:	66 90                	xchg   %ax,%ax
  83:	66 90                	xchg   %ax,%ax
  85:	66 90                	xchg   %ax,%ax
  87:	66 90                	xchg   %ax,%ax
...
printf(int fd, const char *fmt, ...)
{
 ...
 5e4:	eb 1a                	jmp    600 <printf+0x1a0>
          s = "(null)";
 5e6:	bb 03 08 00 00       	mov    $0x803,%ebx
        while(*s != 0){
...
free(void *ap)
{
 ...
 635:	a1 b8 0a 00 00       	mov    0xab8,%eax
{
 ...
 656:	73 10                	jae    668 <free+0x38>
{
 ...
 681:	5b                   	pop    %ebx
  freep = p;
 682:	a3 b8 0a 00 00       	mov    %eax,0xab8
}
 687:	5e                   	pop    %esi
 688:	5f                   	pop    %edi
 689:	5d                   	pop    %ebp
 ...
 6a7:	03 53 fc             	add    -0x4(%ebx),%edx
  freep = p;
 6aa:	a3 b8 0a 00 00       	mov    %eax,0xab8
    p->s.size += bp->s.size;
...
malloc(uint nbytes)
{
 ...
 6cd:	8b 45 08             	mov    0x8(%ebp),%eax
  if((prevp = freep) == 0){
 6d0:	8b 3d b8 0a 00 00    	mov    0xab8,%edi
  nunits = (nbytes + sizeof(Header) - 1)/sizeof(Header) + 1;
 ...
 719:	8b 3d b8 0a 00 00    	mov    0xab8,%edi
 ...
 742:	e8 e9 fe ff ff       	call   630 <free>
  return freep;
 747:	a1 b8 0a 00 00       	mov    0xab8,%eax
 ...
 774:	89 72 04             	mov    %esi,0x4(%edx)
      freep = prevp;
 777:	a3 b8 0a 00 00       	mov    %eax,0xab8
}
 ...
 797:	0a 00 00 
    base.s.size = 0;
 79a:	bf bc 0a 00 00       	mov    $0xabc,%edi
    base.s.ptr = freep = prevp = &base;
 79f:	c7 05 bc 0a 00 00 bc 	movl   $0xabc,0xabc
 7a6:	0a 00 00 
  for(p = prevp->s.ptr; ; prevp = p, p = p->s.ptr){
 7a9:	89 f8                	mov    %edi,%eax
    base.s.size = 0;
 7ab:	c7 05 c0 0a 00 00 00 	movl   $0x0,0xac0
 7b2:	00 00 00 
    if(p->s.size >= nunits){
