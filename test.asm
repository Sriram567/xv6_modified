...
main(void)
{
  ...
  forktest();
   a:	e8 11 00 00 00       	call   20 <forktest>
  exit();
   f:	e8 1f 03 00 00       	call   333 <exit>
  14:	66 90                	xchg   %ax,%ax
  16:	66 90                	xchg   %ax,%ax
  18:	66 90                	xchg   %ax,%ax
  1a:	66 90                	xchg   %ax,%ax
  ...
  28:	31 db                	xor    %ebx,%ebx
{
  ...
  printf(1, "fork test\n");
  2d:	68 08 08 00 00       	push   $0x808
  32:	6a 01                	push   $0x1
  34:	e8 67 04 00 00       	call   4a0 <printf>
  39:	83 c4 10             	add    $0x10,%esp
  3c:	eb 0f                	jmp    4d <forktest+0x2d>
  3e:	66 90                	xchg   %ax,%ax
    if(pid == 0)
  40:	74 4a                	je     8c <forktest+0x6c>
  for(n=0; n<N; n++){
  42:	83 c3 01             	add    $0x1,%ebx
  45:	81 fb a0 86 01 00    	cmp    $0x186a0,%ebx
  4b:	74 6b                	je     b8 <forktest+0x98>
    pid = fork();
  4d:	e8 d9 02 00 00       	call   32b <fork>
    if(pid < 0)
  52:	85 c0                	test   %eax,%eax
  54:	79 ea                	jns    40 <forktest+0x20>
  for(; n > 0; n--){
  56:	85 db                	test   %ebx,%ebx
  58:	74 14                	je     6e <forktest+0x4e>
  5a:	8d b6 00 00 00 00    	lea    0x0(%esi),%esi
    if(wait() < 0){
  60:	e8 d6 02 00 00       	call   33b <wait>
  65:	85 c0                	test   %eax,%eax
  67:	78 28                	js     91 <forktest+0x71>
  for(; n > 0; n--){
  69:	83 eb 01             	sub    $0x1,%ebx
  6c:	75 f2                	jne    60 <forktest+0x40>
  if(wait() != -1){
  6e:	e8 c8 02 00 00       	call   33b <wait>
  73:	83 f8 ff             	cmp    $0xffffffff,%eax
  76:	75 2d                	jne    a5 <forktest+0x85>
  printf(1, "fork test OK\n");
  ...
  94:	68 13 08 00 00       	push   $0x813
  99:	6a 01                	push   $0x1
  9b:	e8 00 04 00 00       	call   4a0 <printf>
      exit();
  a0:	e8 8e 02 00 00       	call   333 <exit>
    printf(1, "wait got too many\n");
  a5:	52                   	push   %edx
  a6:	52                   	push   %edx
  a7:	68 27 08 00 00       	push   $0x827
  ac:	6a 01                	push   $0x1
  ...
  b8:	50                   	push   %eax
  b9:	68 a0 86 01 00       	push   $0x186a0
  be:	68 48 08 00 00       	push   $0x848
  c3:	6a 01                	push   $0x1
  c5:	e8 d6 03 00 00       	call   4a0 <printf>
    exit();
  ca:	e8 64 02 00 00       	call   333 <exit>
  cf:	90                   	nop
...
printf(int fd, const char *fmt, ...)
{
 ...
 624:	eb 1a                	jmp    640 <printf+0x1a0>
          s = "(null)";
 626:	bb 67 08 00 00       	mov    $0x867,%ebx
        while(*s != 0){
...
free(void *ap)
{
 ...
 675:	a1 38 0b 00 00       	mov    0xb38,%eax
{
 ...
 696:	73 10                	jae    6a8 <free+0x38>
{
 ...
 6c1:	5b                   	pop    %ebx
  freep = p;
 6c2:	a3 38 0b 00 00       	mov    %eax,0xb38
}
 6c7:	5e                   	pop    %esi
 6c8:	5f                   	pop    %edi
 6c9:	5d                   	pop    %ebp
 ...
 6e7:	03 53 fc             	add    -0x4(%ebx),%edx
  freep = p;
 6ea:	a3 38 0b 00 00       	mov    %eax,0xb38
    p->s.size += bp->s.size;
...
malloc(uint nbytes)
{
 ...
 70d:	8b 45 08             	mov    0x8(%ebp),%eax
  if((prevp = freep) == 0){
 710:	8b 3d 38 0b 00 00    	mov    0xb38,%edi
  nunits = (nbytes + sizeof(Header) - 1)/sizeof(Header) + 1;
 ...
 759:	8b 3d 38 0b 00 00    	mov    0xb38,%edi
 ...
 782:	e8 e9 fe ff ff       	call   670 <free>
  return freep;
 787:	a1 38 0b 00 00       	mov    0xb38,%eax
 ...
 7b4:	89 72 04             	mov    %esi,0x4(%edx)
      freep = prevp;
 7b7:	a3 38 0b 00 00       	mov    %eax,0xb38
}
 ...
 7d7:	0b 00 00 
    base.s.size = 0;
 7da:	bf 3c 0b 00 00       	mov    $0xb3c,%edi
    base.s.ptr = freep = prevp = &base;
 ...
 7e9:	89 f8                	mov    %edi,%eax
    base.s.size = 0;
 7eb:	c7 05 40 0b 00 00 00 	movl   $0x0,0xb40
 7f2:	00 00 00 
    if(p->s.size >= nunits){
