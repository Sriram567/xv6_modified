...
int main(int argc, char *argv[])
{
  ...
  17:	a1 3c 0b 00 00       	mov    0xb3c,%eax
  1c:	85 c0                	test   %eax,%eax
  1e:	7e 54                	jle    74 <main+0x74>
  ...
  22:	be 50 00 00 00       	mov    $0x50,%esi
  27:	eb 25                	jmp    4e <main+0x4e>
  ...
  3a:	83 c3 01             	add    $0x1,%ebx
      set_priority(100-(20+j),pid); // will only matter for PBS, comment it out if not implemented yet (better priorty for more IO intensive jobs)
  3d:	50                   	push   %eax
  3e:	e8 e8 03 00 00       	call   42b <set_priority>
  43:	83 c4 10             	add    $0x10,%esp
  for (j = 0; j < number_of_processes; j++)
  46:	39 1d 3c 0b 00 00    	cmp    %ebx,0xb3c
  ...
  for (j = 0; j < number_of_processes; j++)
  6c:	39 1d 3c 0b 00 00    	cmp    %ebx,0xb3c
  72:	7f da                	jg     4e <main+0x4e>
    }
  }
  for (j = 0; j < number_of_processes+5; j++)
  74:	83 3d 3c 0b 00 00 fc 	cmpl   $0xfffffffc,0xb3c
  ...
  a3:	3b 05 3c 0b 00 00    	cmp    0xb3c,%eax
  ...
  cc:	3b 05 3c 0b 00 00    	cmp    0xb3c,%eax
 ...
 103:	eb bb                	jmp    c0 <main+0xc0>
      printf(1, "Process: %d Finished %d pid\n", j,getpid());
 105:	e8 f9 02 00 00       	call   403 <getpid>
 10a:	50                   	push   %eax
 10b:	53                   	push   %ebx
...
printf(int fd, const char *fmt, ...)
{
 ...
 674:	eb 1a                	jmp    690 <printf+0x1a0>
          s = "(null)";
 676:	bb 82 08 00 00       	mov    $0x882,%ebx
        while(*s != 0){
...
free(void *ap)
{
 ...
 6c5:	a1 40 0b 00 00       	mov    0xb40,%eax
{
...
malloc(uint nbytes)
{
 ...
 75d:	8b 45 08             	mov    0x8(%ebp),%eax
  if((prevp = freep) == 0){
 760:	8b 3d 40 0b 00 00    	mov    0xb40,%edi
  nunits = (nbytes + sizeof(Header) - 1)/sizeof(Header) + 1;
 ...
 7d2:	e8 e9 fe ff ff       	call   6c0 <free>
  return freep;
 7d7:	a1 40 0b 00 00       	mov    0xb40,%eax
